...
import { Camera, Loader2, ArrowLeft, Plus, RotateCcw } from 'lucide-react';
  ...
  return (
    <div className="relative w-full h-screen bg-[#050505] overflow-hidden font-sans text-white">
      ...
      <div className="absolute inset-0 z-0 bg-[radial-gradient(circle_at_center,#1a1a1a_0%,#000_100%)]">
        <Suspense fallback={<div className="absolute inset-0 flex justify-center items-center"><Loader2 className="animate-spin text-[#00FF94] w-12 h-12" /></div>}>
